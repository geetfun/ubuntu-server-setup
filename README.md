...
```bash
cd ~
git clone https://github.com/geetfun/ubuntu-server-setup
```
...
Finally, you will be prompted to specify a [timezone](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) for the server. It will be set to 'America/Toronto' if you do not specify a value.
